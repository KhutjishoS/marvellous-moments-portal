      ...
      <main className="flex-grow pt-24">
        <section className="section bg-wedding-ivory">
          <div className="container-custom">
            ...
            {/* Placeholder content - will be populated with real florist data */}
              ...
              {[1, 2, 3, 4, 5, 6].map((index) => (
                ...
                >
                  <div className="aspect-[4/3] overflow-hidden bg-wedding-gold/10">
                    <div className="w-full h-full bg-gradient-to-br from-wedding-rose/20 to-wedding-cream flex items-center justify-center text-wedding-rose/40 text-5xl">
                      {index}
                    </div>
                  </div>
                  <div className="p-6">
                    <h3 className="text-xl font-serif mb-2">Floral Designer {index}</h3>
                    <p className="text-wedding-charcoal/70 text-sm mb-4">
                      Creative floral arrangements that transform your ceremony and reception into magical spaces
                    </p>
                    <div className="flex justify-between items-center">
                      <span className="text-wedding-gold font-medium">From R5,000</span>

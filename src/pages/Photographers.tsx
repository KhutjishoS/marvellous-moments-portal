      ...
      <main className="flex-grow pt-24">
        <section className="section bg-wedding-ivory">
          <div className="container-custom">
            ...
            {/* Placeholder content - will be populated with real photographer data */}
              ...
              {[1, 2, 3, 4, 5, 6].map((index) => (
                ...
                >
                  <div className="aspect-[4/3] overflow-hidden bg-wedding-gold/10">
                    <div className="w-full h-full bg-gradient-to-br from-wedding-rose/20 to-wedding-gold/20 flex items-center justify-center text-wedding-gold/40 text-5xl">
                      {index}
                    </div>
                  </div>
                  <div className="p-6">
                    <h3 className="text-xl font-serif mb-2">Photography Studio {index}</h3>
                    <p className="text-wedding-charcoal/70 text-sm mb-4">
                      Professional wedding photographer with an artistic eye for capturing emotional and candid moments
                    </p>
                    <div className="flex justify-between items-center">
                      <span className="text-wedding-gold font-medium">From R8,000</span>
